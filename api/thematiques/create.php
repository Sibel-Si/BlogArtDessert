...
if (empty($recaptcha_secret)) {
    $_SESSION['error_message'] = 'Clé reCAPTCHA non configurée.';
    header('Location: ../../views/backend/members/create.php');
    exit;
}
...
// Vérifier la réponse et gérer les différents formats (v2 sans score / v3 avec score)
if (empty($result) || !isset($result['success']) || $result['success'] != true || (isset($result['score']) && $result['score'] < 0.5)) {
